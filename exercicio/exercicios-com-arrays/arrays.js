...
var data_atual = new Date(); // new Date pega a data atual em um formato especifico
var numero_escolhido = data_atual.getDate(); // getDate nós permiti pegar o dia do mes de uma data
